            ...
            <div class="col-lg-7">
                <div class="widget">
                    <div class="footer-text text-left">
                        <a href="index.html"><img src="{{ asset('EndUserAssets/assets/images/version/tech-footer-logo.png')}}" alt="" class="img-fluid"></a>
...
<script src="{{ asset('EndUserAssets/assets/js/tether.min.js')}}"></script>
